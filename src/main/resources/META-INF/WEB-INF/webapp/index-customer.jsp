			...
			<div class="container">
				<div class="row w-100 align-items-center gx-lg-2 gx-0">
					...
					<div class="col-xxl-2 col-lg-3 col-md-6 col-5">
						<a class="navbar-brand d-none d-lg-block" href="./dashboard/index-admin">
							<img src="./assets/images/logo/convenience-store-svgrepo-com.svg" />
						</a>
						<div class="d-flex justify-content-between w-100 d-lg-none">
							<a class="navbar-brand" href="./dashboard/index-admin.jsp"> <img
		...
		<section class="mb-lg-10 mt-lg-14 my-8" id="category">
			<div class="container">
				...
				<div class="category-slider">
					<div class="item" onclick="scrollCategory('raw-food')">
					...
					<div class="item" onclick="scrollCategory('drink')">
						<div class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
					...
					<div class="item" onclick="scrollCategory('alcohol')">
						<div class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
					...
					<div class="item" onclick="scrollCategory('snack')">
						<div class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
					...
					<div class="item" onclick="scrollCategory('cosmetics')">
						<div class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
					...
					<div class="item" onclick="scrollCategory('home-item')">
						<div class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
					...
					<div class="item" onclick="scrollCategory('stationery')">
						<div class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
