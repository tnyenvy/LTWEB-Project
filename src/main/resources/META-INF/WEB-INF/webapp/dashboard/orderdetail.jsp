							...
							<li class="dropdown ms-4"><a role="button"
								...
								<div class="dropdown-menu dropdown-menu-end p-0">
									...
									<ul class="list-unstyled px-2 py-3">
										<li><a class="dropdown-item" href="/">Trang
												chủ</a></li>
										<li><a class="dropdown-item" href="./admininfo">Thông
												tin cá nhân</a></li>
									</ul>
               ...
               <div class="row mb-8">
                  <div class="col-md-12">
                     <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                        <div>
                           ...
                           <nav aria-label="breadcrumb">
                              <ol class="breadcrumb mb-0">
                                 <li class="breadcrumb-item"><a href="./index-admin" class="text-inherit">Quản lý</a></li>
                                 <li class="breadcrumb-item"><a href="./orders" class="text-inherit">Đơn hàng</a></li>
                        ...
                        <!-- button -->
                        <div>
                           <a href="./orders" class="btn btn-primary">Quay lại</a>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="card h-100 card-lg">
                        <div class="card-body p-6">
                           <div class="d-md-flex justify-content-between">
                              <div class="d-flex align-items-center mb-2 mb-md-0">
                                 ...
                                 <span class="badge bg-light-warning text-dark-warning ms-2">Đang xử lý</span>
                              </div>
                              <!-- select option -->
                              <div class="d-md-flex">
                                 ...
                                 <div class="ms-md-3">
                                    ...
                                    <a href="#" class="btn btn-secondary">Tải về</a>
                                 </div>
                              </div>
                           </div>
                           <div class="mt-8">
                        ...
                        <div class="card-body p-6">
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <h5>Ghi chú</h5>
                                 <textarea class="form-control mb-3" rows="3" placeholder="Ghi chú thông tin đơn hàng"></textarea>
                                 <a href="#" class="btn btn-primary">Lưu</a>
                              </div>
                           </div>
                        </div>
