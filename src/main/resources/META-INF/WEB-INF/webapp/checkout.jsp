               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-4 col-12 border-end d-none d-md-block">
                     <div class="pt-10 pe-lg-10">
                        ...
                        <ul class="nav flex-column nav-pills nav-pills-dark">
                           ...
                           <!-- nav item -->
                           <li class="nav-item">
                              <a class="nav-link active" aria-current="page" href="checkout.jsp">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                     <div class="py-6 p-md-6 p-lg-10">
                        <!-- heading -->
                        <h2 class="mb-6">Thông tin đơn hàng</h2>
                              ...
                              <tbody id="table-cart">
                                 ...
                                 <tr id="total-value">
                                    ...
                                    <td id="total-price" class="align-middle border-top-0">
                                    	<a href="orderdetail-customer.jsp" class="btn btn-primary ms-2">Xem</a></td>                                  
                                 </tr>
                              </tbody>
                           </table>
                        </div>
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasAccount" aria-labelledby="offcanvasAccountLabel">
         ...
         <div class="offcanvas-body">
            <ul class="nav flex-column nav-pills nav-pills-dark">
               ...
               <li class="nav-item">
                  <a class="nav-link active" href="./userinfo.html">
                     <i class="feather-icon icon-settings me-2"></i>
                     Thông tin tài khoản
                  </a>
               </li>
