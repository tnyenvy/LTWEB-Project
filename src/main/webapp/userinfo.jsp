                  ...
                  <div class="col-lg-3 col-md-4 col-12 border-end d-none d-md-block">
                     <div class="pt-10 pe-lg-10">
                        ...
                        <ul class="nav flex-column nav-pills nav-pills-dark">
                           <!-- nav item -->
                           <li class="nav-item">
                              <a class="nav-link " aria-current="page" href="userorder.jsp">
                           ...
                           <!-- nav item -->
                           <li class="nav-item">
                              <a class="nav-link active" href="userinfo.jsp">
                     ...
                     <div class="py-6 p-md-6 p-lg-10">
                        ...
                        <div>
                           ...
                           <div class="row">
                              <div class="col-lg-5">
                                 <!-- form -->
                                 <form onsubmit="changeDetail();return false;">
                                    <!-- input -->
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input id="form-email" type="email" class="form-control" placeholder=" " />
                                    </div>
                                    <!-- input -->
                                    <div class="mb-3">
                                       <label class="form-label">Địa chỉ</label>
                                       <input id="form-address" type="text" class="form-control" placeholder=" " />
                                    </div>
                                    <!-- input -->
                                    <div class="mb-5">
                                       <label class="form-label">Số điện thoại</label>
                                       <input id="form-sdt" type="text" class="form-control" placeholder=" " />
                                    </div>
                                    <!-- button -->
                                    <div class="mb-3">
                        ...
                        <div class="pe-lg-14">
                           ...
                           <form class="row row-cols-1 row-cols-lg-2" onsubmit="changePassword();return false;">
                              <!-- input -->
                              <div class="mb-3 col">
                              ...
                              <div class="mb-3 col">
                                 ...
                                 <input id="cur-password" type="password" class="form-control" placeholder="**********" />
                              </div>
                              <!-- input -->
                              <div class="col-12">
                                 <p class="mb-4">
                        ...
                        <div>
                           ...
                           <!-- btn -->
                           <div class="btn btn-outline-danger" onclick="disableAccount()">Xác nhận</div>
                        </div>
                     </div>
                  </div>
               </div>
