...
<title>Đăng ký Thành viên - Tune Vibe</title>
<!-- Favicon icon-->
		...
		<nav class="navbar navbar-light py-2">
			<div
				...
				<a class="navbar-brand" href="index-customer.jsp"> <img
					src="./assets/images/logo/convenience-store-svgrepo-com.svg" alt=""
			...
			<div class="container">
				...
				<div class="row justify-content-center align-items-center">
					<div class="col-12 col-md-6 col-lg-4 order-lg-1 order-2">
						<!-- img -->
						<img src="./assets/images/svg-graphics/signup-g.svg" alt=""
							class="img-fluid" />
					</div>
					<!-- col -->
					<div
						...
						<div class="mb-lg-9 mb-5">
							<h1 class="mb-1 h2 fw-bold">Đăng ký Thành viên để bắt đầu
								mua sắm ngay</h1>
							<p>Chào mừng đến với Tune Vibe! Vui lòng nhập Email để tiếp
								tục.</p>
						</div>
						<!-- form -->
						<form name="signup-form" onsubmit="signup();return false;">
							<div class="row g-3">
								<!-- col -->
								<div class="modal-body">
									<div class="mb-3">
										...
										<div id="signup-invalid-name" class="text-danger" hidden>Vui
											lòng nhập tên của bạn</div>
									</div>
									<div class="mb-3">
										<input type="email" class="form-control" id="signup-email"
											placeholder="Địa chỉ Email" />
										<div id="signup-invalid-email" class="text-danger" hidden>Vui
											lòng nhập địa chỉ Emai hợp lệ</div>
									</div>
									<div class="mb-3">
										<input type="password" class="form-control"
											id="signup-password" placeholder="Mật khẩu" />
										<div id="signup-invalid-password" class="text-danger" hidden>Vui
											lòng nhập mật khẩu</div>
									</div>
									<!-- Đky xong trả về trang Đăng nhập -->
								...
								<!-- text -->
								<p>
									<small class="form-text"> Bằng cách tiếp tục, bạn đồng
										ý với <a href="#!">Điều Khoản Sử Dụng</a> và <a href="#!">Điều
