...
<title>Thêm danh mục mới - Tune Vibe</title>
<!-- Favicon icon-->
				...
				<div class="navbar-vertical">
					...
					<div class="navbar-vertical-content flex-grow-1" data-simplebar="">
						<ul class="navbar-nav flex-column">
							<li class="nav-item"><a class="nav-link "
								href="../dashboard/index-admin.jsp">
									<div class="d-flex align-items-center">
										<span class="nav-link-icon"><i class="bi bi-house"></i></span>
										<span>Quản lý</span>
									</div>
                        ...
                        <div>
                           ...
                           <nav aria-label="breadcrumb">
                              <ol class="breadcrumb mb-0">
                                 ...
                                 <li class="breadcrumb-item"><a href="categories.jsp" class="text-inherit">Danh mục</a></li>
                                 <li class="breadcrumb-item active" aria-current="page">Thêm danh mục mới</li>
                              </ol>
                           </nav>
                        </div>
                        <div>
                           <a href="categories.jsp" class="btn btn-light">Quay lại</a>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-lg-12 col-12">
                     ...
                     <div class="card mb-6 shadow border-0">
                        ...
                        <div class="card-body p-6">
                           ...
                           <h4 class="mb-4 h5 mt-5">Thông tin chi tiết</h4>
                           ...
                           <div class="row">
                              ...
                              <div class="mb-3 col-lg-6">
                                 ...
                                 <input type="text" class="form-control flatpickr" placeholder="Chọn ngày" />
                              </div>
                              ...
                              <div class="col-lg-12">
                                 ...
                                 <a href="#" class="btn btn-secondary ms-2">Lưu</a>
                              </div>
                           </div>
                        </div>
                     </div>
