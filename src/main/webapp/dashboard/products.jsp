...
<title>Sản phẩm - Tune Vibe</title>
<!-- Favicon icon-->
				...
				<div class="d-flex justify-content-between align-items-center w-100">
					...
					<div>
						<ul
							...
							<li class="dropdown ms-4"><a href="#" role="button"
		...
		<div class="main-wrapper">
			...
			<nav class="navbar-vertical-nav d-none d-xl-block">
				<div class="navbar-vertical">
					<div class="px-4 py-5">
						<a href="../dashboard/index-admin.jsp" class="navbar-brand"> <img
					...
					<div class="row mb-8">
						<div class="col-md-12">
							...
							<div class="d-md-flex justify-content-between align-items-center">
								<div>
									<h2>Các sản phẩm của cửa hàng</h2>
									<!-- breacrumb -->
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb mb-0">
											<li class="breadcrumb-item"><a href="index-admin.jsp"
												class="text-inherit">Quản lý</a></li>
					...
					<div class="row">
						<div class="col-xl-12 col-12 mb-5">
							...
							<div class="card h-100 card-lg">
											...
											<tbody>
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productOne" /> <label class="form-check-label"
																for="productOne"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-1.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Haldiram's Sev
															Bhujia</a></td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productTwo" /> <label class="form-check-label"
																for="productTwo"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-2.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">NutriChoice
															Digestive</a></td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productThree" /> <label class="form-check-label"
																for="productThree"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-3.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Cadbury 5 Star
															Chocolate</a></td>
													<td>Snack & Munchies</td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productFour" /> <label class="form-check-label"
																for="productFour"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-4.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Onion Flavour
															Potato</a></td>
													<td>Snack & Munchies</td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productFive" /> <label class="form-check-label"
																for="productFive"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-5.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Salted Instant
															Popcorn</a></td>
													<td>Instant Food</td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productSix" /> <label class="form-check-label"
																for="productSix"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-6.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Blueberry Greek
															Yogurt</a></td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productSeven" /> <label class="form-check-label"
																for="productSeven"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-7.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Britannia
															Cheese Slices</a></td>
													<td>Dairy, Bread & Eggs</td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productEight" /> <label class="form-check-label"
																for="productEight"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-8.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Blueberry Greek
															Yogurt</a></td>
													<td>Instant Food</td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productNine" /> <label class="form-check-label"
																for="productNine"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-9.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Slurrp Millet
															Chocolate</a></td>
													<td>Instant Food</td>
												...
												<tr>
													<td>
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value=""
																id="productTen" /> <label class="form-check-label"
																for="productTen"></label>
														</div>
													</td>
													<td><a href="#!"><img
															src="../assets/images/products/product-img-10.jpg" alt=""
															class="icon-shape icon-md" /></a></td>
													<td><a href="#" class="text-reset">Amul Butter -
															500 g</a></td>
													<td>Instant Food</td>
								...
								<!-- Hiển thị giao diện với các SP được load từ CSDL -->
								<!-- <div class="card-body p-0">
    <div class="table-responsive">
            ...
            <tbody>
                <c:forEach var="product" items="${products}">
                    <tr>
                        ...
                        <td>
                            <a href="#!">
                                <img src="${product.imageUrl}" alt="Product Image" class="icon-shape icon-md" />
                            </a>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="badge 
                                <c:choose>
                                    <c:when test="${product.status == 'Active'}">bg-light-primary text-dark-primary</c:when>
                                    <c:when test="${product.status == 'Deactive'}">bg-light-danger text-dark-danger</c:when>
                                    <c:otherwise>bg-light-warning text-dark-warning</c:otherwise>
                                </c:choose>">
                                ${product.status}
                            </span>
                        </td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="deleteProduct?id=${product.id}">
                                            <i class="bi bi-trash me-3"></i> Delete
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="editProduct?id=${product.id}">
