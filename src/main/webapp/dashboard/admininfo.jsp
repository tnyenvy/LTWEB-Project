...
<html lang="en">
   <head>
      ...
      <title>Thông tin cá nhân - Tune Vibe</title>
      <!-- Favicon icon-->
                  ...
                  <div class="offcanvas-body">
                        ...
                        <div class="collapse mt-2" id="collapseExample">
                           <div class="card card-body">
                              <ul class="mb-0 list-unstyled">
                                 <li><a class="dropdown-item" href="./pages/shop-grid.html">Thực phẩm & Đồ uống</a></li>
                                 <li><a class="dropdown-item" href="./pages/shop-grid.html">Sản phẩm cá nhân</a></li>
                                 <li><a class="dropdown-item" href="./pages/shop-grid.html">Đồ dùng gia đình</a></li>
                                 <li><a class="dropdown-item" href="./pages/shop-grid.html">Văn phòng phẩm</a></li>
                     ...
                     <div class="dropdown me-3 d-none d-lg-block">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                           		 <li><a class="dropdown-item" href="./shop-grid.html">Thực phẩm & Đồ uống</a></li>
                                 <li><a class="dropdown-item" href="./shop-grid.html">Sản phẩm cá nhân</a></li>
                                 <li><a class="dropdown-item" href="./shop-grid.html">Đồ dùng gia đình</a></li>
                                 <li><a class="dropdown-item" href="./shop-grid.html">Văn phòng phẩm</a></li>
                     </div>
                     <div>
                        <ul class="navbar-nav align-items-center">
                           
                           <li class="nav-item dropdown w-100 w-lg-auto dropdown-fullwidth">
                              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Tất cả sản phẩm</a>
                              <div class="dropdown-menu pb-0">
                                 <div class="row p-2 p-lg-4">
                                    <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                       <h6 class="text-primary ps-3">Thực phẩm và đồ uống</h6>
                                       <a class="dropdown-item" href="./shop-grid.html">Thực phẩm tươi sống</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Thực phẩm chế biến sẵn</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Bánh kẹo các loại</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Đồ ăn nhẹ</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Thức uống giải khát</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Đồ uống có cồn</a>
                                    </div>
                                    <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                       <h6 class="text-primary ps-3">Sản phẩm cá nhân</h6>
                                       <a class="dropdown-item" href="./shop-grid.html">Sữa tắm</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Dầu gội</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Vệ sinh răng miệng</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Sản phẩm y tế</a>
                                    </div>
                                    <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                       <h6 class="text-primary ps-3">Đồ dùng gia đình</h6>
                                       <a class="dropdown-item" href="./shop-grid.html">Giấy vệ sinh</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Túi rác</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Bột giặt</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Phụ kiện điện tử</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Đồ chơi trẻ em</a>
                                    </div>
                                    <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                       <h6 class="text-primary ps-3">Văn phòng phẩm</h6>
                                       <a class="dropdown-item" href="./shop-grid.html">Bút</a>
                                       <a class="dropdown-item" href="./shop-grid.html">Sổ, giấy</a>
                                    </div>
                           <!--        <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                           ...
                           <li class="nav-item dropdown w-100 w-lg-auto">
                              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Thành viên</a>
                              <ul class="dropdown-menu">
                                 <li><a class="dropdown-item" href="./signin.html">Đăng nhập</a></li>
                                 <li><a class="dropdown-item" href="./signup.html">Đăng ký</a></li>
                                 <li><a class="dropdown-item" href="./forgot-password.html">Quên mật khẩu</a></li>
                                 <li class="dropdown-submenu dropend">
                                    <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Tài khoản của tôi</a>
                                    <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="./account-orders.html">Giỏ hàng</a></li>
                                       <li><a class="dropdown-item" href="./account-settings.html">Thông tin cá nhân</a></li>
                                       <li><a class="dropdown-item" href="./account-payment-method.html">Phương thức thanh toán</a></li>
                                    </ul>
                                 </li>
                              </ul>
                           </li>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                     <div class="py-6 p-md-6 p-lg-10">
                        <div class="mb-6">
                           <!-- heading -->
                           <h2 class="mb-0">Thiết lập tài khoản</h2>
                        </div>
                        <div>
                           <!-- heading -->
                        ...
                        <div class="pe-lg-14">
                           ...
                           <form class="row row-cols-1 row-cols-lg-2">
                              ...
                              <!-- input -->
                              <div class="mb-3 col">
                                 <label class="form-label">Vui lòng nhập lại mật khẩu trước đây</label>
                                 <input type="password" class="form-control" placeholder="**********" />
                              </div>
                              <!-- input -->
                              <div class="col-12">
                                 <p class="mb-4">
                                    Quên mật khẩu? 
                                    <a href="../pages/forgot-password.html">Lấy lại mật khẩu.</a>
                                 </p>
                        ...
                        <div>
                           <!-- heading -->
                           <h5 class="mb-4">Xóa tài khoản</h5>
                           <p class="mb-2">Bạn có chắc muốn xóa tài khoản không?</p>
                           <p class="mb-5">Mọi thông tin liên quan đến tài khoản bao gồm: thông tin cá nhân, sản phẩm trong giỏ hàng sẽ bị xóa.</p>
                           <!-- btn -->
                           <a href="#" class="btn btn-outline-danger">Xác nhận</a>
                        </div>
                     </div>
                  </div>
               </div>
