            ...
            <div class="main-content-inner">
                ...
                <div class="card-body"
                    ...
                    <div style="display: flex; padding-right: 15px">
                        ...
                        <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Bạn muốn tìm gì?"
                        ...
                        <c:forEach items="${productsWithPaging.data}" var="product"
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary"
                                       href="${base }/admin/product/add-product/${product.id}" role="button">Thay đổi</a>
