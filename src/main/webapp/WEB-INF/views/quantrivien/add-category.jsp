...
<title>Thêm Danh mục - Tune Vibe</title>
								...
								<sf:form modelAttribute="addCate" class="needs-validation"
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											...
											<div class="valid-feedback">Hoàn tất!</div>
										</div>

									</div>
									<div class="form-row">
										<div class="col-md-6 mb-3">
											<label for="validationCustom03">SEO (Search Engine Optimization)</label>
											...
											<div class="invalid-feedback">Vui lòng nhập SEO!</div>
										</div>
