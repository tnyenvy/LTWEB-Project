...
<title>Tất cả sản phẩm - Tune Vibe</title>
<link rel="stylesheet"
		...
		<div class="content">
			...
			<div class="content-bar">
					...
					<div class="filter-price">
						<ul class="checkbox-list">
							...
							<li><input type="checkbox" id="p2" name="cc"
								...
								<label for="p2">10,000đ - 50,000đ</label></li>
							<li><input type="checkbox" id="p3" name="cc"
								data-price="((price:product>)&amp;&amp;(price:product<=))">
								<label for="p3">50,000đ - 100,000đ</label></li>
							<li><input type="checkbox" id="p4" name="cc"
								data-price="((price:product>)&amp;&amp;(price:product<=))">
								<label for="p4">100,000đ - 200,000đ</label></li>
				...
				<div class="title-bar-price">
					<div class="title-bar-p1">Trạng thái</div>
					<div class="filter-price">
						<ul class="price">
							<li>
								<button type="button" id="size">Còn hàng</button>
							</li>
							<li>
								<button type="button" id="size">Hết hàng</button>
							</li>
						</ul>
					</div>
				</div>
						...
						<div class="card-body">
							<div class="card-body-a">
								...
								<input type="text" id="keyword" name="keyword"
									class="form-control" placeholder="Bạn muốn mua gì?"
